...
namespace SeemplestLight.PortableCore.IoC
{
    ...
    public interface IServiceContainer: IServiceLocator
    {
        ...
        bool ContainsCreated<TInterface>();
        ...
        bool ContainsCreated<TInterface>(string key);
        ...
        /// <param name="createInstanceImmediately">If true, forces the creation of the default
        /// instance of the provided class.</param>
        void Register<TInterface>(Func<TInterface> factory, bool createInstanceImmediately)
            where TInterface : class;
        ...
        void Unregister<TInterface>(TInterface instance)
            where TInterface : class;
