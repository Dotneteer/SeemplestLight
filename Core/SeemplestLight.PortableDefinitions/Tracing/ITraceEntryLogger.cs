namespace SeemplestLight.PortableCore.Tracing
{
    ...
    public interface ITraceEntryLogger
    {
        ...
        void Log(TraceEntryType type, string operationType, string message, string detailedMessage = null);
